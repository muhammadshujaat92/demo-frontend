...
<div style="font-family: Arial, sans-serif; color: #333; border: 2px solid #ff7300; padding: 20px;">
        ...
        <div style="border: 1px solid #999999; margin: 30px 0px; padding: 0 2px 2px 2px;">
            <div style="display: flex; align-items: center; gap: 2px;">
                <div
                    style="border: 1px solid #999999; padding: 8px; text-align: left; font-size: 13px; width:5rem; margin-top: 2px; font-weight: 600;">
                    Name</div>
            ...
            <div style="display: flex; gap: 2px;">
                <div style="display: flex; align-items: center; gap: 2px; width: 50%;">
                    <div
                        style="border: 1px solid #999999; padding: 8px; text-align: left; font-size: 13px; width:5rem; min-width: 4.2rem; max-width: 4.5rem; margin-top: 2px; font-weight: 600;">
                        Adults</div>
                    <div style="border: 1px solid #999999; padding: 8px; margin-top: 2px; font-size: 13px; width: 90%;">${adult}</div>
                </div>
                <div style="display: flex; align-items: center; gap: 2px; width: 50%;">
                    <div
                        style="border: 1px solid #999999; padding: 8px; text-align: left; font-size: 13px; width:5rem; min-width: 4.5rem; max-width: 4.5rem; margin-top: 2px; font-weight: 600;">
                        Childrens</div>
                    <div style="border: 1px solid #999999; padding: 8px; margin-top: 2px; font-size: 13px; width: 90%;">${children}</div>
                </div>
            </div>
            <div style="display: flex; gap: 2px;">
                <div style="display: flex; align-items: center; gap: 2px; width: 50%;">
                    <div
                        style="border: 1px solid #999999; padding: 8px; text-align: center; font-size: 13px; width:5rem; min-width: 4.2rem; max-width: 5rem; margin-top: 2px; font-weight: 600;">
                        Country</div>
                    <div style="border: 1px solid #999999; padding: 8px; margin-top: 2px; font-size: 13px; width: 90%;">${country}</div>
                </div>
                <div style="display: flex; align-items: center; gap: 2px; width: 50%;">
                    <div
                        style="border: 1px solid #999999; padding: 8px; text-align: left; font-size: 13px; width:5rem; min-width: 4.5rem; max-width: 4.5rem; margin-top: 2px; font-weight: 600;">
                        City</div>
                    <div style="border: 1px solid #999999; padding: 8px; margin-top: 2px; font-size: 13px; width: 90%;">${city}</div>
                </div>
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 2px;">
                <div
                    style="border: 1px solid #999999; padding: 8px; text-align: center; font-size: 13px; width:4.5rem; margin-top: 2px; font-weight: 600;">
                    Message</div>
