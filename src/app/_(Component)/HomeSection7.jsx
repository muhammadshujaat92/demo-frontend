                ...
                <div className='md:relative top-0 md:block flex flex-col items-center'>
                    {
                        backImg ? (
                            ...
                            <Image src={defaultImg1} alt='img' width={470} height={470} className='rounded-3xl' />
                        )
                    }
                    <div className='md:absolute top-[-70px] left-[230px] my-[2rem] md:my-0'>
                        {
                            frontImg ? (
                                ...
                                <Image src={defaultImg2} alt='img' width={280} height={280} className='rounded-3xl border-[8px] border-white' />
                            )
                        }
                    </div>
